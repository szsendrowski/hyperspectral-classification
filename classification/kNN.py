...
def train_knn_classifier(
    ...
    **model_params
    ...
    print(gdf["class"].value_counts() if "class" in gdf.columns else gdf["label_id"].value_counts())
    ...
    # Trening kNN
    print(f"[INFO] Trenuję kNN ({model_params})...")
    ...
    print(f"[DONE] Mapa klasyfikacji (kNN) zapisana: {map_out}")
    return knn, metrics
